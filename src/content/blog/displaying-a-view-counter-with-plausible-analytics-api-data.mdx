...
import img1 from "../../assets/blog/displaying-a-view-counter-with-plausible-analytics-api-data/b33c6e2c1e0f1f52d6ccc8d9e0ec7070282d035b.png";
import img2 from "../../assets/blog/displaying-a-view-counter-with-plausible-analytics-api-data/6339313725e3437cda9f64082ee4ba8fe635df24.png";
...
<PostImage src={img1} alt="Location of the API key settings in Plausible Analytics" />
...
```url
/api/v1/stats/aggregate?site_id=<SITE_ID>&period=<PERIOD>&filters=event:page==<SLUG>
```
...
<PostImage src={img2} alt="Loading state of the DisplayViews component" />
